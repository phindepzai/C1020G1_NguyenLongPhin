...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity security) throws Exception {
        ...
        security.authorizeRequests().antMatchers("/admin/**").access("hasRole('ADMIN')");
        security.authorizeRequests().antMatchers("/dba/**").access("hasRole('DBA')");
        ...
        security.authorizeRequests().and().rememberMe().rememberMeParameter("remember").tokenRepository(this.persistentTokenRepository())
