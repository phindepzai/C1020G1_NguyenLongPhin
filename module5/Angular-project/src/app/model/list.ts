...
export const studentList: IStudent[] = [
    ...
    { id: 4, name: 'Le Phuoc Thanh Cao', age: 25, mark: 8, avatar: 'https://kenh14cdn.com/2018/3/4/2846802318924576207879858810573997153717090n-1520142824274618702811.jpg' },
    { id: 5, name: 'Doan Ngoc Linh', age: 25, mark: 10, avatar: 'https://meocun.com/wp-content/uploads/5.png' }
];
